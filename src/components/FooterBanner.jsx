    ...
    return (
        <div className="relative h-[500px] max-h-[500px] w-full bg-black overflow-hidden">
            ...
            <div className="absolute  inset-0 flex flex-col items-center justify-center text-white bg-black/40 px-4 sm:gap-4 gap-2">
                ...
                <div className='flex items-center gap-2 sm:gap-4 py-4 sm:text-base text-sm'>
                    {isAuthenticated ? (
                        <p className="rounded-sm bg-white/15 px-4 py-2 text-center font-semibold text-white backdrop-blur-sm">
                            You're already a member. Keep going with your fitness journey.
                        </p>
                    ) : (
                        <Link
                            to="/login"
                            className="px-4 py-2 bg-[#2424B9] font-semibold text-white rounded-sm flex gap-2 items-center w-fit"
                        >
                            Join Now
                        </Link>
                    )}
